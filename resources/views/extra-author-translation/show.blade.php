...
@section('template_title')
    {{ $extraAuthorTranslation->name ?? __('Show') }}
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {{ $extraAuthorTranslation->locale }}
                        </div>
                        <div class="form-group">
                            <strong>Extra Author Id:</strong>
                            {{ $extraAuthorTranslation->extra_author_id }}
                        </div>
                        <div class="form-group">
                            <strong>Title:</strong>
                            {{ $extraAuthorTranslation->title }}
                        </div>
                        <div class="form-group">
                            <strong>Slug:</strong>
                            {{ $extraAuthorTranslation->slug }}
                        </div>
                        <div class="form-group">
                            <strong>Content:</strong>
                            {{ $extraAuthorTranslation->content }}
                        </div>
