                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                    $title = null;
                                                    if (count($extraAuthor->extraAuthorTranslations) > 0 && isset($extraAuthor->extraAuthorTranslations[$step]) && $extraAuthor->extraAuthorTranslations[$step]->locale == $k) {
                                                        $title = $extraAuthor->extraAuthorTranslations[$step]->title;
