                                ...
                                <div class="card-body">
                                    ...
                                    <div class="box box-info padding-1">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label
                                                    for="passport_seria_number">{{ __('Passport series and number') }}</label>
                                                <input type="text"
                                                       class="form-control  {{ $errors->has('passport_seria_number') ? ' is-invalid' : '' }}"
                                                       placeholder="{{ __('Passport series and number') }}"
                                                       name="passport_seria_number" id="passport_seria_number"
                                ...
                                <div class="card-body">
                                    <div class="ec-cat-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @else
                                                ...
                                                <select id="branch_id"
                                                        ...
                                                        wire:model="branch_id"
                                                        wire:change="$set('branch_id', null)"
                                                >
                                                    <option value>{{ __('Choose') }}</option>
                                                </select>
                                            @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            @else
                                                <div>
                                                    <select id="department_id" class=" form-select form-control "
                                                            wire:model="department_id">
                                                        <option value>{{ __('Choose') }}</option>
                                                    </select>
                                                    @endif
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @if($this->hemisImagePath != null)
                                                        <div class="align-items-left">
                                                            <img src="{{$this->hemisImagePath}}" width="100">
                                                        </div>
                                                    @else
                                                        <br>
{{--                                                        <input type="file" name="file" class='form-control' accept="image/*" />--}}

                                                        <input type="file" wire:model="user_image" accept="image/*"
                                                               class='form-control'>

                                                        <div wire:loading wire:target="user_image">{{ __('Uploading') }}
                                                            ...
                                                        </div>
