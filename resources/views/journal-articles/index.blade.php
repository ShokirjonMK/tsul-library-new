            ...
            <div class="col-12">
                <div class="ec-vendor-list card card-default">
                    <div class="card-header">
                        <form action="{{ route('journal-articles.index', app()->getLocale()) }}" method="GET"
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('journal-articles.index', app()->getLocale()) }}"
                                    class="btn btn-sm btn-info ">{{ __('Clear') }}</a>
                                {{-- <a href="{{ route('journal-articles.export', [app()->getLocale(), 'keyword' => $keyword]) }}"
                                ...
                                <tbody>
                                    @foreach ($scientificPublications as $scientificPublication)
                                        <tr>
                                            ...
                                            <td>{{ $scientificPublication->journal->title }}</td>
                                            <td>
                                               {{ $scientificPublication->scientificPublication->published_year }} | {{ $scientificPublication->scientificPublication->fourth_number }}
                                            </td>
