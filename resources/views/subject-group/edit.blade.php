...
<div class="content">
    ...
    <div class="breadcrumb-wrapper breadcrumb-contacts">
        ...
        <div>
            <a href="{{ url(app()->getLocale() . '/admin/subject-groups') }}"  class="btn btn-primary" >{{ __('Back') }}</a>
        </div>
    </div>

    @includeif('partials.errors')
    <form method="POST" action="{{ route('subject-groups.update', [app()->getLocale(), $subjectGroup->id]) }}"  role="form" enctype="multipart/form-data">
        {{ method_field('PATCH') }}
        @csrf
