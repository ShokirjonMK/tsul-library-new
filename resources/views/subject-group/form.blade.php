                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                    $title = null;
                                                     if (count($subjectGroup->subjectGroupTranslations) > 0 && isset($subjectGroup->subjectGroupTranslations[$step]) && $subjectGroup->subjectGroupTranslations[$step]->locale == $k) {
                                                        $title = $subjectGroup->subjectGroupTranslations[$step]->title;
                                                    }
                                                    $step++;
                                                @endphp
            ...
            <div class="card-body">
                <div class="ec-cat-form">
                    <div class="form-group row">
                        ...
                        {{ Form::text('code', $subjectGroup->code, ['class' => 'form-control' . ($errors->has('code') ? ' is-invalid' : ''), 'placeholder' => 'Code']) }}
                        {!! $errors->first('code', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
                    @php
                        $isActive = 1;
                        if ($subjectGroup->count() > 0 && isset($subjectGroup->isActive)){
