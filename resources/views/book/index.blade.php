                                        ...
                                        <form action="{{ route('books.index', app()->getLocale()) }}" method="GET"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    @if ($bookSubjects->count() > 0)
                                                        <div class="form-group">
                                                            {!! Form::label('fields_science_id', __('Dc Subjects')) !!} :
                                                            <br>
                                                            {!! Form::select('fields_science_id', $bookSubjects, $fields_science_id, [
                                                                 'class' => 'border  p-2 bg-white',
                                                                 'placeholder' => __('Choose'),
                                                             ]) !!}
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" class="form-control" name="dc_date" id="dc_date"
                                                           placeholder="{{ __('Dc Date') }}" value="{{ $dc_date }}">
                                                </div>
                                                <div class="col-md-3">
                                                    @if ($organizations->count() > 0)
                                                        <div class="form-group">
                                                            {!! Form::label('organization_id', __('Organization')) !!} :
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <form action="{{ route('books.index', app()->getLocale()) }}" method="GET"
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div class="form-group">
                                                <input type="text" class="form-control " name="muallif" id="muallif"
                                                       value="{{ $muallif }}" placeholder="{{ __('Authors') }}"/>
                                            </div>
