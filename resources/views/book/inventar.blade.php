                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <select class="form-select" id="status" name="status">
                                                    <option value=""
                                                            @if (is_null($status)) selected @endif > {{ __('Choose') }}</option>
                                                    <option value="0"
                                                            @if ($status==="0") selected @endif > {{ __('DELETED') }}</option>
                                                    <option value="1"
                                                            @if ($status==1) selected @endif >  {{ __('Active') }}</option>
                                                    <option value="2"
                                                            @if ($status==2) selected @endif >  {{ __('GIVEN') }}</option>
                                                    <option value="3"
                                                            @if ($status==3) selected @endif >   {{ __('WAREHOUSED') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    @foreach ($barcodes as $book_inventar)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {!! $book_inventar->organization ? $book_inventar->organization->title : '' !!}
                                                <br>
                                            ...
                                            <td>
                                                ...
                                                @if (Auth::user()->hasRole('SuperAdmin') || Auth::user()->hasRole('Admin') || Auth::user()->hasRole('Manager'))
                                                    ...
                                                    <button class="btn-sm btn btn-warning open_modal"
                                                            data-inventar="{{$book_inventar->id}}">
                                                        {{ __('To the storage') }}
                                                    </button>
                                                @endif
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.inventarstorage', app()->getLocale()) }}" role="form"
