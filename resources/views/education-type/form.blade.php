                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                    $title = null;
                                                     if (count($educationType->educationTypeTranslations) > 0 && isset($educationType->educationTypeTranslations[$step]) && $educationType->educationTypeTranslations[$step]->locale == $k) {
                                                        $title = $educationType->educationTypeTranslations[$step]->title;
                                                    }
                                                    $step++;
                                                @endphp
            ...
            <div class="card-body">
                <div class="ec-cat-form">
                    <div class="form-group row">
                        ...
                        {{ Form::text('code', $educationType->code, ['class' => 'form-control' . ($errors->has('code') ? ' is-invalid' : ''), 'placeholder' => 'Code']) }}
                        {!! $errors->first('code', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
                    @php
                        $isActive = 1;
                        if ($educationType->count() > 0 && isset($educationType->isActive)){
                            $isActive = $educationType->isActive;
                        }
