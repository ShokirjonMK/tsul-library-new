...
<div class="content">
    ...
    <div class="breadcrumb-wrapper breadcrumb-contacts">
        ...
        <div>
            <a href="{{ url(app()->getLocale() . '/admin/book-taken-without-permissions') }}"  class="btn btn-primary" >{{ __('Back') }}</a>
        </div>
    </div>

    @includeif('partials.errors')
    <form method="POST" action="{{ route('book-taken-without-permissions.update', [app()->getLocale(), $bookTakenWithoutPermission->id]) }}"  role="form" enctype="multipart/form-data">
        {{ method_field('PATCH') }}
        @csrf
