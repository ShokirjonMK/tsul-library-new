 ...
 * @property $updated_at
 *
 * @property EducationTypeTranslation[] $educationTypeTranslations
 * @property User $user
 * @property User $updatedBy
 * @package App
 * @mixin \Illuminate\Database\Eloquent\Builder
 */
class EducationType extends Model   implements TranslatableContract
{
     ...
     */
    public function educationTypeTranslations()
    {
        return $this->hasMany('App\Models\EducationTypeTranslation', 'education_type_id', 'id');
    }
    ...
    {
        $model = EducationType::updateOrCreate(
