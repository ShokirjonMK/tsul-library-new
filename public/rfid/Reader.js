    ...
    GetTagInfo() {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                //     var tbody = [];
                //
                //     var requests = taginfo.map((item, index) => {
                //         // window.location.origin+
                //         console.log(item.m_code)
                //         return $.ajax({
                //             type: "GET",
                //             url: window.location.origin+"/api/v1/books-inventars/"+item.m_code +"/getbook", // Adjust API endpoint
                //             dataType: "json"
                //         }).done(function (bookRes) {
                //             console.log(bookRes);
                ...
                //             tbody.push('<td>' + (bookData.title || 'N/A') + '</td>');  // Add title
                //             tbody.push('<td>' + (bookData.author || 'N/A') + '</td>'); // Add author
                //             tbody.push('<td>' + (bookData.publisher || 'N/A') + '</td>'); // Add publisher
                //             tbody.push('</tr>');
                //         });
                //     });
