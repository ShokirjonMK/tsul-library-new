...
$(document).ready(function() {
  ...
  var erkak = document.getElementById("erkak").value;
  var ayol = document.getElementById("ayol").value;
  if (doughnut !== null) {
        ...
        datasets: [
          {
            ...
            data: [erkak, ayol],
            backgroundColor: ["#88aaf3", "#50d7ab"],
            borderWidth: 1,
            borderColor: ['#88aaf3','#29cc97'],
            hoverBorderColor: ['#88aaf3', '#29cc97'],
          }
        ]
      },
      options: {
        ...
        tooltips: {
          callbacks: {
            title: function(tooltipItem, data) {
              return "Soni : " + data["labels"][tooltipItem[0]["index"]];
            },
            label: function(tooltipItem, data) {
              return data["datasets"][0]["data"][tooltipItem["index"]];
            }
